...
| 기능 | CSS<br>1:1 채팅<br>매칭받은 리스트<br>프로필 등록<br>DB 구축| 통계<br>로그인/회원가입<br>관리자| 신고 관리<br>DB 구축| 마이 페이지<br>권한 관리<br>권한 관리<br>DB 구축| 자유게시판<br>매칭추천 리스트(랜덤)<br>권한 관리<br>DB 구축
